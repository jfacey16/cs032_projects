...
public class DistanceCompareTest {
	...
	public void testCompare() {
		...
		DistanceCompare dComparator =
				new DistanceCompare(referencePoint);
	...
	public void testsSquareDistance() {
		...
		assertEquals(dComparator.squareDistance(testPoint1, referencePoint), 12.0, .1);
		assertEquals(dComparator.squareDistance(testPoint2, referencePoint), 27.0, .1);

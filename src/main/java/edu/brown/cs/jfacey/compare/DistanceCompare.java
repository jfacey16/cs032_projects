...
/**
 * This class defines a distance comparator that compares two points distance to
 * a reference point.
 *
 * @author jfacey
 *
...
public class DistanceCompare implements Comparator<Kdpoint> {
  ...
  /**
   * This constructor just sets the reference point instance variable.
   *
   * @param point
   *          the reference point
   */
  ...
  /**
   * This method overrides the standard comparator compare method to return
   * based on comparing the distances of two points to a reference point.
   *
   * @param o1
   *          point one being compared
   * @param o2
   *          point two being compared
  ...
  /**
   * This method finds the square distance between two points. This method uses
   * squared distances as it is easier computationally, and functionally the
   * same.
   *
   * @param p1
   *          point 1 for distance
   * @param p2
   *          point 2 for distance

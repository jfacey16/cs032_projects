...
/**
 * This interface defines a kdpoint which is the type
 * that is inserted into kdtrees. It stores values
 * for a 3d binary tree point with getters and setters.
 *
 * @author jfacey
 *
 */
public interface Kdpoint {
	 ...
	 *
	 * @param parent the parent node of the point
	 */
	 ...
	 *
	 * @param lChild the left child node of the point's
	 */
	 ...
	 *
	 * @param rChild the right child node of the point
	 */
	 ...
	 *
	 * @param posZ the z position of the point
	 */
